 ...
 */
export declare const WriteBar: ({ className, style, before, inlineAfter, after, getRootRef, getRef, onHeightChange, shadow, defaultValue, ...restProps }: WriteBarProps) => JSX.Element;
