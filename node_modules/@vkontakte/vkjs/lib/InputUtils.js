...
exports.hasTouchEvents = exports.hasTouch = exports.hasMouse = exports.hasHover = void 0;
...
if (_dom.canUseDOM) {
  if (_IOSDetections.isIOS && !_IOSDetections.isIPadOS) {
    ...
    if (hasTouch) {
      ...
      exports.hasMouse = hasMouse = typeof window.matchMedia === 'function' && window.matchMedia('(pointer)').matches ? matchMedia('(pointer: fine)').matches : notMobile;
      exports.hasHover = hasHover = hasMouse && (typeof window.matchMedia === 'function' && window.matchMedia('(hover)').matches ? matchMedia('(hover: hover)').matches : notMobile);
    } else {
