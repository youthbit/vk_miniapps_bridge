...
export declare const isIPad: boolean, isIPhone: boolean, isIOS: boolean, isIPadOS: boolean, iosMajor: number, iosMinor: number, isWKWebView: boolean, isScrollBasedViewport: boolean, isIPhoneX: boolean, isIOSChrome: boolean;
