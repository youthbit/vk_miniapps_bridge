...
describe('throttle', function () {
  ...
  test('should call functions as usual if they exceed threshold interval', function () {
    fnThrottled(1);
  ...
  test('should trigger last call at the end of threshold', function () {
    fnThrottled(1);
    expect(fn.mock.calls).toEqual([[1]]);
  ...
  test('should call not more than once per threshold and preserve correct call order', function () {
    fnThrottled(1);
...
describe('debounce', function () {
  ...
  test('should debounce function call', function () {
    fnDebounced(1);
