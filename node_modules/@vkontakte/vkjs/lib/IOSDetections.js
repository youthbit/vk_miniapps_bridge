...
exports.IPHONE_X_SAFARI_BOTTOM_BAR = exports.IPHONE_SAFARI_BOTTOM_BAR = exports.IPHONE_KEYBOARD_REJECT_OFFSET = exports.IOS_NO_KEYBOARD_ALLOWED_OFFSET = void 0;
exports.checkIPadOS = checkIPadOS;
exports.detectIOS = detectIOS;
exports.isIPhoneX = exports.isIPhone = exports.isIPadOS = exports.isIPad = exports.isIOSChrome = exports.isIOS = exports.iosMinor = exports.iosMajor = void 0;
exports.isLandscapePhone = isLandscapePhone;
exports.isWKWebView = exports.isScrollBasedViewport = void 0;
...
function checkWKWebView(ua) {
  ...
  if (ua.indexOf('safari') !== -1 && ua.indexOf('version') !== -1 && !navigator.standalone) {
